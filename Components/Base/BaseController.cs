...
namespace Components.Base
{
    ...
    {
        public Authentication _Authentication => new Authentication(HttpContext);
        /// <summary>
        /// 是否登录
        /// </summary>
        /// <returns></returns>
        ...
        public string HostName
        {
            get
            {
                if (string.IsNullOrEmpty(_hostName))
                {
                    ...
                    var result = reg.Match(url, 0).Value;
                    _hostName = result;
                }
                return _hostName;
            }
        ...
        public bool IsMobile
        {
            get
            {
                var uAgent = Request.Headers["User-Agent"].ToString();
                ...
                return b.IsMatch(uAgent) || v.IsMatch(uAgent.Substring(0, 4));
            }
        }
    }
}